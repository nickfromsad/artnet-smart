 ...
 * describe its channels, and push it into this array — actions.js and presets.js
 * build everything else from this data automatically.
 */
export const fixtureRegistry = [asteraHeliosProfile7, asteraHeliosProfile14, lupoDayledCct, genericDimmer]
