...
individually-addressable pixels on one fixture) appears on **Start Effect**, right
alongside the other effect fields. `0` keeps all of that fixture's pixels perfectly in
